...
description: This skill provides expertise in GraphQL schema design and API architecture. This skill should be used for GraphQL schema design, resolver optimization, federation, performance issues, or subscription implementation. Focuses on enterprise-grade GraphQL APIs.
enforcement_level: HIGH
violation_consequence: GraphQL APIs may be poorly designed, perform poorly, or fail to scale, requiring significant refactoring
---

# GraphQL Architecture

This skill provides comprehensive guidance for enterprise-grade GraphQL API design, schema architecture, and performance optimization. It emphasizes scalable, maintainable GraphQL APIs.

## Overview

GraphQL architecture involves designing schemas, optimizing resolvers, implementing federation, and ensuring performance. This skill provides systematic approaches to GraphQL API design.
