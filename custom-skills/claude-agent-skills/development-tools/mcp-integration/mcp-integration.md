...
description: This skill provides expertise in Model Context Protocol (MCP) integration for the cli-tool components system. This skill should be used when creating MCP server configurations, implementing protocol specifications, or designing integration patterns. Focuses on production-ready implementations.
enforcement_level: HIGH
violation_consequence: MCP integrations may be insecure, non-compliant with protocol, or fail in production, requiring significant refactoring
---

# MCP Integration

This skill provides comprehensive guidance for creating, configuring, and optimizing MCP (Model Context Protocol) integrations for the claude-code-templates CLI system. It covers server architecture, protocol specifications, and integration patterns.

## Overview

MCP integration involves designing and implementing MCP servers that follow protocol specifications, provide secure authentication, and optimize performance. This skill provides systematic approaches to MCP server creation and configuration.

## ✓ Pre-Integration Checklist

**BEFORE creating MCP integration, verify:**

```yaml
Checklist:
  - [ ] Target service/API identified
  - [ ] Authentication requirements analyzed
  - [ ] Required methods and capabilities determined
  - [ ] Error handling and retry logic planned
  - [ ] Rate limiting and performance considered
...
- Action: STOP
- Reason: Missing information required for effective MCP integration
- Next step: Gather missing requirements before proceeding

**IF ALL CHECKED:**
- Output: "✅ Pre-integration verification complete: Ready to create MCP"
- Proceed with: MCP creation workflow
...
When creating MCP integrations, always follow these standards and provide production-ready implementations that are robust, secure, and performant.
