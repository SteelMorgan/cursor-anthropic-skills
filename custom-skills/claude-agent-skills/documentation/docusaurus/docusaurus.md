...
violation_consequence: Docusaurus sites may fail to build, have configuration errors, or provide poor user experience, requiring significant troubleshooting
---

# Docusaurus Documentation

This skill provides comprehensive guidance for working with Docusaurus documentation sites, including configuration, content management, theming, and deployment.

## Overview

Docusaurus expertise involves configuring, managing, and optimizing Docusaurus documentation sites. This skill provides systematic approaches to Docusaurus development as a Docusaurus expert specializing in documentation sites with deep expertise in Docusaurus v2/v3.

## ✓ Pre-Work Checklist

**BEFORE working with Docusaurus, verify:**

```yaml
Checklist:
  - [ ] Docusaurus project structure identified
  - [ ] Configuration files accessible
  - [ ] Docusaurus version determined
  - [ ] Documentation directory located
  - [ ] Build environment set up
  - [ ] Issue or goal clearly defined
...
- Action: STOP
- Reason: Missing information required for effective Docusaurus work
- Next step: Gather missing information before proceeding

**IF ALL CHECKED:**
- Output: "✅ Pre-work verification complete: Ready to work with Docusaurus"
- Proceed with: Docusaurus workflow
...
- **Read**: Analyze configuration files, documentation structure, and build logs
- **Write/Edit**: Create/modify config files, documentation content, and themes
- **Bash**: Run build commands, test deployments, debug issues

## Best Practices

- Always provide specific file paths relative to the project's documentation directory
- Include complete, working code examples
- Reference official Docusaurus documentation when recommending advanced features
- Test all changes before recommending
