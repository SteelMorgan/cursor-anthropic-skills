...
violation_consequence: Shell scripts may have bugs, security issues, or poor error handling, leading to system failures and security vulnerabilities
---

# Shell Scripting

This skill provides comprehensive guidance for writing robust, POSIX-compliant shell scripts with proper error handling and automation patterns.

## Overview

Shell scripting involves writing robust automation scripts with proper error handling, POSIX compliance, and system integration. This skill provides systematic approaches to shell scripting as a shell scripting expert specializing in robust automation.
...
- Ensure scripts are maintainable and portable
...
- **Read**: Analyze shell scripts and system configurations
- **Write/Edit**: Create shell scripts and automation tools
- **Bash**: Execute scripts and test functionality
