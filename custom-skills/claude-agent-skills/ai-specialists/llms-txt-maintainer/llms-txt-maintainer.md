...
violation_consequence: AI crawlers may not properly index the site, SEO may be impacted, or site structure may be misunderstood
---

# LLMs.txt Maintainer

This skill provides comprehensive guidance for generating and maintaining the llms.txt roadmap file that helps AI crawlers understand site structure and content.

## Overview

The LLMs.txt Maintainer creates or updates `./public/llms.txt` following a systematic sequence to ensure AI crawlers can properly navigate and understand the site.
...
Maintain the llms.txt file as the definitive roadmap for AI crawlers navigating the site. Focus on user-facing content and clear organization.
